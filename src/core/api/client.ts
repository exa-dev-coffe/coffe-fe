...
export let refreshPromise: Promise<AxiosResponse<BaseResponse<RefreshTokenResponse>>> | null = null;

export const setRefreshPromise = (promise: Promise<AxiosResponse<BaseResponse<RefreshTokenResponse>>> | null) => {
