const CardHistoryWalletSkeleton = () => {
    return (
        <div
            className={'w-full border-y border-gray-300 dark:border-gray-700 h-36 bg-white dark:bg-gray-800 animate-pulse'}>
            <div className={'flex justify-between items-center h-full'}>
                ...
                <div className={'flex flex-col items-end gap-2'}>
                    <div className={'w-36 h-6 bg-gray-200 dark:bg-gray-700 rounded'}></div>
                    <div className={'w-28 h-8 bg-gray-200 dark:bg-gray-700 rounded'}></div>
                </div>
            </div>
        </div>
    )
