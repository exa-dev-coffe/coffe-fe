...
export const ListCategoryPage: React.FC = () => {
    ...
    const { mutateAsync: addCategory, isPending: addLoading, error: addError } = useAddCategoryMutation();
    const { mutateAsync: deleteCategory, isPending: deleteLoading } = useDeleteCategoryMutation();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            await addCategory({ name: nameInput });
            setDrawerOpen(false);
            setNameInput("");
        } catch {
